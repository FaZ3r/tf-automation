...
for x in range(10):
    ...
    if (log_type == 'ERROR'):
        logs.append("{} {} - [{}] - {}\n".format(random_log_date(), random_log_time(), log_type, random_fail_log_message()))
    elif (log_type == 'DEBUG'):
        logs.append("{} {} - [{}] - {}\n".format(random_log_date(),random_log_time(), log_type, random_debug_log_message()))
    else:
        log_time = random_log_time()
        log_date= random_log_date()
        app = random_app_log()
        logs.append("{} {} - [{}] - {}".format(log_date, log_time, log_type, random_success_log_message_running(app)))
        logs.append("{} {} - [{}] - {}\n".format(log_date,log_time, log_type, random_success_log_message_ms(app, random_ms())))
